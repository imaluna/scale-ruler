(function (global, factory) {
  ...
  var ScaleRuler = /*#__PURE__*/function () {
    ...
    return _createClass(ScaleRuler, [{
      ...
      key: "_checkObject",
      value: function _checkObject(options) {
        if (!isObject(options)) {
      ...
      value: function _initPositionLine(opt, isVertical, ruler) {
        ...
        function rulerMouseMoveEvent(e) {
          ...
          var translate = 0;
          if (isY) {
            positionEl.style.visibility = e.pageY > offset.top + rulerConfig.horizontalRulerHeight ? 'visible' : 'none';
            translate = e.pageY - offset.top;
          } else {
            positionEl.style.visibility = e.pageX > offset.left + rulerConfig.verticalRulerWidth ? 'visible' : 'none';
        ...
        ruler.addEventListener('mousedown', function () {
          ...
          for (var i in positionElStyle) {
            positionEl.style[i] = positionElStyle[i];
          }
          for (var _i2 in lineElStyle) {
            lineEl.style[_i2] = lineElStyle[_i2];
          }
          for (var _i3 in tipElStyle) {
            tipEl.style[_i3] = tipElStyle[_i3];
          }
          ...
          document.addEventListener('mouseup', function (e) {
            ...
            if (nodeInfo) {
              var _positionEl = nodeInfo.positionEl,
                ...
                id = nodeInfo.id;
              var isY = _dir === 'y';
              if (!isY && e.pageX <= offset.left + rulerConfig.verticalRulerWidth || isY && e.pageY <= offset.top + rulerConfig.horizontalRulerHeight) {
      ...
      value: function _addPosisitionLineEvent(nodeInfo, offset) {
        ...
        function positionLineMoveEvent(e) {
          ...
          var isY = dir === 'y';
          var move = (isY ? e.pageY : e.pageX) - start;
      ...
      value: function _createScollBar(isVertical) {
        ...
        var mousemoveEvent = function mousemoveEvent(e) {
          ...
          var translateX = canvasConfig.translateX,
            translateY = canvasConfig.translateY;
          if (isVertical) {
            var move = e.pageY - scrollConfig.startY;
            ...
            var _move = e.pageX - scrollConfig.startX;
