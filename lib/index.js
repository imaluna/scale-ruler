    ...
    return _createClass(ScaleRuler, [{
      ...
      value: function _initPositionLine(opt, isVertical, ruler) {
        ...
        function rulerMouseMoveEvent(e) {
          ...
          var coordinate = self._translateToCoordinate(opt, dir, translate);
          // 检查吸附线
          ...
          document.addEventListener('mouseup', function (e) {
            ...
            if (nodeInfo) {
              ...
              if (!isY && targetCoordinate.pageX <= offset.left + rulerConfig.verticalRulerWidth || isY && targetCoordinate.pageY <= offset.top + rulerConfig.horizontalRulerHeight) {
                ...
                // positionEl事件监听
                _this2._addPositionLineEvent(nodeInfo, offset);
              }
            }
      ...
      value: function _addPositionLineEvent(nodeInfo, offset) {
        var positionEl = nodeInfo.positionEl,
          tipEl = nodeInfo.tipEl,
          dir = nodeInfo.dir;
        ...
        function positionLineMoveEvent(e) {
          ...
          // 更新坐标数据
          var coordinate = self._translateToCoordinate(self.opt, dir, translate);
          // 检查吸附线
          var info = self._checkAdSorptionLine(coordinate, dir, translate);
          self._setLineTranslate(dir, info.translate, positionEl);
          self._checkTipPosition(info.translate, dir, positionEl, tipEl);
      ...
      value: function _translateToCoordinate(opt, dir, translate) {
        var scale = opt.scale,
          canvasConfig = opt.canvasConfig;
        var translateX = canvasConfig.translateX,
          translateY = canvasConfig.translateY;
      ...
      value: function _setLineTranslate(dir, translate, node) {
      ...
      value: function _changeLinesTranslate() {
        ...
        ids.forEach(function (id) {
          ...
          var translate = _this3._coordinateToTranslate(coordinate, dir);
          _this3._setLineTranslate(dir, translate, positionEl);
          _this3._checkTipPosition(translate, dir, positionEl, tipEl);
      ...
      value: function _mousewheelEvent(e) {
        ...
        if (e.metaKey || e.ctrlKey) {
          ...
          var _this$opt4 = this.opt,
            scrollConfig = _this$opt4.scrollConfig,
      ...
      value: function _addScrollBarEvent(bar, isVertical) {
        ...
        var mousemoveEvent = function mousemoveEvent(e) {
          ...
          _this5._transformCanvas();
          _this5._onMove(translateX, translateY);
        };
      ...
      value: function updateCanvasRect(_ref2) {
      ...
      value: function removeAdsorptionLine(data) {
        this._modifyAdsorptionLine(data, true);
      }
      // 增加吸附线
    }, {
      key: "addAdsorptionLine",
      value: function addAdsorptionLine(data) {
